...
public interface ICsvParser {
    ...
    /// <summary>
    /// Converts the CSV file located at the specified file path into an enumerable collection of objects of type <typeparamref name="T" />.
    ...
    /// </summary>
    /// <typeparam name="T">The type of the objects to create from the CSV records. Must be a class with a parameterless constructor.</typeparam>
    ...
    /// <returns>An asynchronous enumerable collection of objects of type <typeparamref name="T" /> representing the parsed data.</returns>
    ...
    /// <summary>
    /// Asynchronously converts CSV data from the provided <see cref="TextReader"/> into an array of objects of the specified type.
    ...
    /// <returns>
    /// A <see cref="ValueTask"/> representing the asynchronous operation, containing an array of objects of type <typeparamref name="T" /> created from the parsed CSV data.
    /// </returns>
    ...
    /// <returns>An asynchronous enumerable of dictionaries, where each dictionary contains the column header as the key and the corresponding value from the CSV row.</returns>
    ...
    /// <param name="reader">The text reader from which to read the CSV data.</param>
    /// <returns>
    /// An array of dictionaries, with each dictionary containing mappings from column names to their respective cell values.
    /// </returns>
    ...
    /// Each dictionary represents a row in the CSV, with the keys being the column headers and the values being the corresponding field values in that row.
    /// </summary>
    /// <param name="filePath">The path to the CSV file to be parsed.</param>
    /// <returns>
    /// A list of dictionaries where each dictionary represents a single row of the CSV file.
    /// The keys in the dictionary correspond to the headers of the CSV file, and the values correspond to the row's values for those headers.
    /// </returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a list of dictionaries,
    /// where each dictionary includes key-value pairs mapping column headers to values from the corresponding row.</returns>
    ...
    /// <returns>A ValueTask representing the asynchronous operation, containing a list of dictionaries where each dictionary represents a CSV row.</returns>
    ...
    /// <param name="data">An enumerable collection of dictionaries representing the data to be written, where each dictionary corresponds to a CSV record.</param>
    ...
    /// <summary>
    /// Asynchronously parses a collection of dictionaries representing data and writes it to a specified text writer in CSV format.
    /// </summary>
    /// <param name="data">
